    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.action_pc:
                ...
                Intent intent1 = intent.setClassName(getApplicationContext().getPackageName(), "com.ammostafa.stickykeep.PcActivity");
                startActivity(intent);
                return true;

            case R.id.action_web:

                intent.setClassName( getApplicationContext().getPackageName(),"com.ammostafa.stickykeep.WebActivity");
                startActivity(intent);
                return true;
            default:
